...
def train_val_holdout_split_images(root_path, train_ratio  = 0.7, validation_ratio = 0.2, holdout_ratio = 0.1):
    """
...
train_val_holdout_split_images('../data/Banana_People_Not')
